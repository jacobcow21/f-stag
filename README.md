...
Most public "sports analytics" demos use toy datasets. This project uses **StatsBomb Open Data** — real, event-level tracking data from professional matches (La Liga, Champions League, NWSL, etc.) — to build models that mirror what clubs actually use internally.
